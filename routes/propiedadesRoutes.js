...
router.post(
  ...
  body("tamano")
    .isNumeric()
    .withMessage("El tamaño debe ser un número en metros cuadrados")
    .notEmpty()
    .withMessage("El tamaño no puede ir vacío"),
  body("habitaciones")
    .isNumeric()
...
router.post(
  ...
  protegerRuta,
  upload.single("imagen"), //subir una (1) sola imagen
  // upload.array; //subir multiples imagenes
  alamcenarImagen
);
