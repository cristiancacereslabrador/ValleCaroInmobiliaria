...
const buscador = async (req, res) => {
  ...
  //Consulktar las propiedades
  const propiedades = await Propiedad.findAll({
    where: {
      titulo: { [Sequelize.Op.like]: "%" + termino + "%" }, //De este modo el buscado busca, al inicio, en el medio y al final de la cadena el "termino"
    },
    include: [{ model: Precio, as: "precio" }],
  });
